# Identity and Access Management for AWS SDK for Ruby<a name="security-iam"></a>
...
For an overview of IAM users and why they are important for the security of your account, see [AWS Security Credentials](https://docs.aws.amazon.com/general/latest/gr/aws-security-credentials.html) in the [ General Reference]()\.
