# Getting Information about All Amazon S3 Buckets in a Region<a name="s3-example-get-buckets-in-region"></a>

The following code example lists the names of available Amazon S3 buckets for the specified AWS Region\.
