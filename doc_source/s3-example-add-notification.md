# Triggering a Notification When an Item is Added to an Amazon S3 Bucket<a name="s3-example-add-notification"></a>

The following code example adds an event notification to an Amazon S3 bucket\.
