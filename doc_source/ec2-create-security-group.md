# Creating an Amazon EC2 Security Group<a name="ec2-create-security-group"></a>

The following code example creates an Amazon EC2 security group and then adds an outbound rule to that security group\.
