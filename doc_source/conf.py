...
#
# AWS SDK for Ruby Developer Guide documentation build configuration file, created by
...
project = u'AWS SDK for Ruby Developer Guide'
...
htmlhelp_basename = 'AWSRubyDeveloperGuide'
...
latex_documents = [
  (master_doc, 'AWSRubyDeveloperGuide.tex', project,
   author, 'manual'),
]
...
man_pages = [
    (master_doc, 'awsrubydeveloperguide', project,
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'AWSRubyDeveloperGuide', project,
   author, 'AWSRubyDeveloperGuide', 'One line description of project.',
   'Miscellaneous'),
]
...
feedback_folder_id = 'ec3ce67f-14bf-4d51-a7f7-ac623933ef43'
