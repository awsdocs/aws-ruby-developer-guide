# Decrypting an Amazon S3 Bucket Object with an AWS KMS Key<a name="s3-example-client-side-decrypt-item-with-kms-master-key"></a>
...
See the [complete example](https://github.com/awsdocs/aws-doc-sdk-examples/blob/master/ruby/s3/s3_get_cskms_decrypt_item.rb) on GitHub\.