# Getting Information about All Amazon EC2 Instances<a name="ec2-example-get-instances"></a>

The following code example lists the IDs and current states of available Amazon EC2 instances\.
