# Create User Access Keys for an IAM User<a name="iam-example-create-user-access-keys"></a>

The following example creates an access key and secret key for the IAM user `my_groovy_user` in the `us-west-2` region\.
