# Creating and Using an Amazon S3 Bucket<a name="s3-example-create-buckets"></a>

The following code example:

1. Lists available buckets in Amazon S3 for the specified AWS Region\.

1. Creates two buckets\.

1. Uploads an object to one of the buckets\.

1. Copies the uploaded object to the other bucket\.

1. Deletes the object from the first bucket\.
