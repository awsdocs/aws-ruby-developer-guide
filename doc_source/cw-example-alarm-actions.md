# Enabling and Disabling Amazon CloudWatch Alarm Actions<a name="cw-example-alarm-actions"></a>

The following code example:

1. Creates and enables a new CloudWatch alarm \(or updates an existing alarm, if an alarm with the specified name already exists\)\.

1. Disables the new or existing alarm\. To enable the alarm again, call `enable_alarm_actions`\.
