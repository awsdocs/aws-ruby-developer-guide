# Configuring an Amazon S3 Bucket for CORS<a name="s3-example-bucket-cors"></a>

This following code example adds a cross\-origin resource sharing \(CORS\) configuration containing a single rule to an Amazon S3 bucket\.
