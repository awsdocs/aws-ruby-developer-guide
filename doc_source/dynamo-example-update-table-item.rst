...
The following example updates the rating to **0.1** for the item with the year
:code-ruby:`2015` and title :code-ruby:`The Big New Movie`
...
See the `complete example <https://github.com/awsdocs/aws-doc-sdk-examples/blob/master/ruby/example_code/dynamodb/dynamodb/dynamodb_ruby_example_update_movies_item.rb>`_
on GitHub.
