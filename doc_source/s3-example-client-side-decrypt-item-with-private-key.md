# Decrypting an Amazon S3 Bucket Object with a Private Key<a name="s3-example-client-side-decrypt-item-with-private-key"></a>

The following code example downloads an object from an Amazon S3 bucket\. The object’s contents were originally encrypted with an RSA public key\.
