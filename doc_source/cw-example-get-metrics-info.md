# Getting Information about Custom Metrics for Amazon CloudWatch<a name="cw-example-get-metrics-info"></a>

The following code example:

1. Adds datapoints to a custom metric in CloudWatch\.

1. Displays a list of available metrics for a metric namespace in CloudWatch\.
