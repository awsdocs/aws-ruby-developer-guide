# Changing the Properties for an Amazon S3 Bucket Object<a name="s3-example-set-item-props"></a>

The following code example copies an object from one Amazon S3 bucket to another\. It also sets a predetermined access control list \(ACL\) and an Amazon S3 storage class on the copied object\.
