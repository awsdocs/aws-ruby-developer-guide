# Encrypting an Amazon S3 Bucket Object on the Server<a name="s3-example-server-side-encryption"></a>

The following code example adds an encrypted object to an Amazon S3 bucket\. The encryption is performed on the server by using the aws/s3 AWS managed customer master key \(CMK\)\.
