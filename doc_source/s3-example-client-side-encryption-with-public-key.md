# Encrypting an Amazon S3 Bucket Object with a Public Key<a name="s3-example-client-side-encryption-with-public-key"></a>

The following code example uploads an object to an Amazon S3 bucket\. The object’s contents are encrypted with an RSA public key\.
