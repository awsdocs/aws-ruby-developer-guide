# Getting Information about All Amazon S3 Buckets<a name="s3-example-get-buckets"></a>

The following example lists the names of up to 50 available Amazon S3 buckets for the specified AWS Region\.
