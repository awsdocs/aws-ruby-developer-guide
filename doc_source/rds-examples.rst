...
.. toctree::
   ...
   rds-example-get-instances
   rds-example-get-snapshots
   rds-example-get-cluster-snapshots
   rds-example-get-security_groups
   rds-example-get-subnet-groups
   rds-example-get-parameter_groups
   rds-example-create-snapshot
   rds-example-create-cluster-snapshot
