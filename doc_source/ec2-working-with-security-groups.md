# Working with Amazon EC2 Security Groups<a name="ec2-working-with-security-groups"></a>

The following example:

1. Creates an Amazon EC2 security group\.

1. Adds inbound rules to the security group\.

1. Displays information about available security groups\.

1. Deletes the security group\.
