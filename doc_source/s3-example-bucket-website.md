# Using a Amazon S3 Bucket to Host a Website<a name="s3-example-bucket-website"></a>

The following code example shows how to configure an Amazon S3 bucket as a static website\.
