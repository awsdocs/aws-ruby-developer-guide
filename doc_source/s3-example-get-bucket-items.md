# Getting Information about Amazon S3 Bucket Objects<a name="s3-example-get-bucket-items"></a>

The following code example lists up to the first 1,000 objects in the specified bucket in Amazon S3\.
