# Sending a Message to an Email Address in Amazon SES<a name="ses-example-send-email"></a>
...
See the [complete example](https://github.com/awsdocs/aws-doc-sdk-examples/blob/master/ruby/ses/ses_send_email.rb) on GitHub\.