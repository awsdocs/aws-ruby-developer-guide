# Creating an Amazon S3 Bucket Policy with Ruby<a name="s3-example-set-bucket-policy"></a>
...
1. Change the bucket policy\.

1. Remove the bucket policy from the bucket\.
